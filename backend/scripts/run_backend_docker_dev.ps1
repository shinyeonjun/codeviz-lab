...
if (-not (Test-Path $venvPython)) {
    throw "backend\venv가 없습니다. 먼저 Python 가상환경과 의존성을 설치해 주세요."
}
...
$env:RUNNER_DOCKER_JAVA_IMAGE = "codeviz-java-sandbox:latest"
$env:RUNNER_TIMEOUT_SECONDS = "5"
$env:RUNNER_C_TIMEOUT_SECONDS = "45"
